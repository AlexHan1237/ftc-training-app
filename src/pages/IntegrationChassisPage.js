    ...
    return (
        <Container>
            ...
            <Row className="px-4 my-5">
                ...
                <Col sm={8}>
                    <h4>Step 3. Motor-Transmission Assembly </h4>
            ...
            <Row className="px-4 my-5">
                ...
                <Col sm={8}>
                    <h4>Step 4. Mecanum Wheels Assembly </h4>
            ...
            <Row className="px-4 my-5">
                ...
                <Col sm={8}>
                    <h4>Step 5. Starter Bot Chassis Assembly </h4>
            ...
            <Row className="px-4 my-5">
                ...
                <Col sm={8}>
                    <h4>Step 6. Attaching Control Hub and Battery Pack </h4>
