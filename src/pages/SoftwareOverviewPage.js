...
function SoftwareOverviewPage() {
    return (
        <Container>
            ...
            <ul>
                <li>Robot Controller Programming: Various actuators in a FTC robot are contorlled by an on-board computer system called
                    ...
                    SDK functions. We will show detailed steps to install and set the TeleOps development environment.
                </li>
                <li>Robot Design Using CAD: CAD software allows for highly precise and accurate designs of robotic components and systems.
                    In FTC robot design, since CAD models of many pre-built components are linked with OnShape web application, we will
                    share a tutorial of basic OnShape modeling in this chapter.
                </li>
            </ul>
        </Container>)
}
