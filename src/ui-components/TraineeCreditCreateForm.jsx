...
import { createTraineeCredit } from "../graphql/mutations";
const client = generateClient();
export default function TraineeCreditCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSectionTitle(initialValues.sectionTitle);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createTraineeCredit.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "TraineeCreditCreateForm")}
      {...rest}
    >
      <TextField
        label="User name"
